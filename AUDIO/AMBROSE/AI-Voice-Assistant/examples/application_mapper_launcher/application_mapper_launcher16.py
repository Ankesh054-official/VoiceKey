    ...
    def launch(self):
        ...
        try:
            if os.path.exists(self.path):
                ...
                # Use start command for launching Microsoft Store apps
                print(f"Launching {self.name} using store URI...")
                subprocess.run(["start", "ms-appx-web://"+self.path], shell=True)  # Launch Store app
            else:
            ...
            if result.returncode == 0:
                ...
                for line in output_lines[3:]:  # Skip headers
                    ...
                    if len(parts) >= 2:
                        ...
                        # Store URI for apps like Calculator or Alarm
