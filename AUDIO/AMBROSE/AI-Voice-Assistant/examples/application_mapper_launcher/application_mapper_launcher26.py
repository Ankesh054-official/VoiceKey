    ...
    def launch(self):
        ...
        try:
            if os.path.exists(self.path):
                ...
                # Correct format for Microsoft Store apps: "explorer.exe shell:AppsFolder\{package_name}!App"
                subprocess.run(f"explorer.exe shell:AppsFolder\\{self.path}", shell=True)
            else:
