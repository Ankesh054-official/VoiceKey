    ...
    def launch(self):
        ...
        try:
            if os.path.exists(self.path):
                ...
                # Use the format "explorer.exe shell:AppsFolder\{package_name}!App"
                subprocess.run(f"explorer.exe shell:AppsFolder\\{self.path}!App", shell=True)
            else:
            ...
            if result.returncode == 0:
                ...
                for line in output_lines[3:]:  # Skip headers
                    ...
                    if len(parts) >= 2:
                        ...
                        # The correct format for AppsFolder launch
